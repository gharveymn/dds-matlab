...
BiMap DXTMEX::g_pmflag_map
{
	...
	{DirectX::TEX_PMALPHA_REVERSE,      "REVERSE"},
	{DirectX::TEX_PMALPHA_SRGB_IN,      "SRGB_IN"},
	{DirectX::TEX_PMALPHA_SRGB_OUT,     "SRGB_OUT"},
...
BiMap DXTMEX::g_compressflag_map
{
	...
	{DirectX::TEX_COMPRESS_A_DITHER,         "A_DITHER"},
	{DirectX::TEX_COMPRESS_DITHER,           "DITHER"},
	{DirectX::TEX_COMPRESS_UNIFORM,          "UNIFORM"},
	{DirectX::TEX_COMPRESS_BC7_USE_3SUBSETS, "BC7_USE_3SUBSETS"},
	{DirectX::TEX_COMPRESS_BC7_QUICK,        "BC7_QUICK"},
	{DirectX::TEX_COMPRESS_SRGB_IN,          "SRGB_IN"},
	{DirectX::TEX_COMPRESS_SRGB_OUT,         "SRGB_OUT"},
	{DirectX::TEX_COMPRESS_SRGB,             "SRGB"},
...
BiMap DXTMEX::g_cnflag_map
{
	...
	{DirectX::CNMAP_CHANNEL_GREEN, "CHANNEL_GREEN"},
	{DirectX::CNMAP_CHANNEL_BLUE, "CHANNEL_BLUE"},
	{DirectX::CNMAP_CHANNEL_ALPHA, "CHANNEL_ALPHA"},
	{DirectX::CNMAP_CHANNEL_LUMINANCE, "CHANNEL_LUMINANCE"},
	{DirectX::CNMAP_MIRROR_U, "MIRROR_U"},
	{DirectX::CNMAP_MIRROR_V, "MIRROR_V"},
	{DirectX::CNMAP_MIRROR, "MIRROR"},
	{DirectX::CNMAP_INVERT_SIGN, "INVERT_SIGN"},
...
BiMap DXTMEX::g_cmseflag_map
{
	...
	{DirectX::CMSE_IMAGE2_SRGB, "IMAGE2_SRGB"},
	{DirectX::CMSE_IMAGE1_X2_BIAS, "IMAGE1_X2_BIAS"},
	{DirectX::CMSE_IMAGE2_X2_BIAS, "IMAGE2_X2_BIAS"},
	{DirectX::CMSE_IGNORE_RED, "IGNORE_RED"},
	{DirectX::CMSE_IGNORE_GREEN, "IGNORE_GREEN"},
	{DirectX::CMSE_IGNORE_BLUE, "IGNORE_BLUE"},
	{DirectX::CMSE_IGNORE_ALPHA, "IGNORE_ALPHA"},
};
