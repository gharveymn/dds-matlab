...
namespace DDSMex
{
	...
	BiMap format_map{{DXGI_FORMAT_UNKNOWN,                    "UNKNOWN"},
	...
	BiMap ctrlflag_map{{DirectX::DDS_FLAGS_NONE,                 "None"},
	...
	BiMap filterflag_map{{DirectX::TEX_FILTER_POINT,            "POINT"},
	...
	BiMap fr_map{{DirectX::TEX_FR_ROTATE0,         "ROTATE0"},
